...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_5x6_right(
     ...
     KC_PGDN, KC_PGUP,MO(2) , MO(1) ,KC_LALT, KC_SPC,                                MO(1) , KC_ENT, KC_LBRC,  KC_RBRC,KC_BACKSLASH,
  ...
  [1] = LAYOUT_5x6_right(
     ...
     KC_TRNS, KC_TRNS, KC_TRNS, KC_CAPS, KC_TRNS, KC_TRNS,                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  ...
  [2] = LAYOUT_5x6_right(
     ...
     KC_TRNS, KC_TRNS, KC_TRNS, RGB_VAD, RGB_VAI, KC_TRNS,                    KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_TRNS, KC_TRNS,
